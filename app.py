...
# -------------------------------------------------------------------
# SmartPay Standard Desktop Update Check API
# Installed SmartPay calls:
# https://devi-payroll-api.onrender.com/smartpay-standard/latest-version
...
def smartpay_standard_latest_version():
    return jsonify(
        {
            "ok": True,
            "product": "SmartPay India Standard",
            "latest_version": os.environ.get("SMARTPAY_STANDARD_LATEST_VERSION", "1.0.3"),
            "download_url": os.environ.get("SMARTPAY_STANDARD_DOWNLOAD_URL", ""),
            "release_notes": os.environ.get("SMARTPAY_STANDARD_RELEASE_NOTES", ""),
            "force_update": _bool_from_env(os.environ.get("SMARTPAY_STANDARD_FORCE_UPDATE", "false")),
            "sha256": os.environ.get("SMARTPAY_STANDARD_SHA256", ""),
        }
    )
