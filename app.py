...
# Keep desktop update/version routes working even when PostgreSQL is expired/down.
# License, admin and backup routes still initialize/use the database.
NO_DB_ENDPOINTS = {
    "home",
    "health",
    "smartpay_standard_latest_version",
    "smartpay_standard_latest_version_by_channel",
    "static",
}
